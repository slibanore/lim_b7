...
from .ultrasat_fiducial_pars import *
...
def get_fiducials(derive_pars, developer, z):
	...
	for i in range(len(derive_pars)):
		...
		if derive_pars[i] == 'z0_Lyalpha':
			fiducials.append(z0_Lyalpha_fid)
			names.append(r'$z_0$')

		if derive_pars[i] == 'f0_Lyalpha':
			fiducials.append(f0_Lyalpha_fid)
			names.append(r'$f_0$')

		if derive_pars[i] == 't_Lyalpha':
			fiducials.append(t_Lyalpha_fid)
			names.append(r'$\vartheta$')

		if derive_pars[i] == 'A_lya':
			fiducials.append(A_Lyalpha_fid)
			names.append(r'$\mathcal{A}$')

		if derive_pars[i] == 'B_lya':
			fiducials.append(B_Lyalpha_fid)
			names.append(r'$\mathcal{B}$')

		if derive_pars[i] == 'D_lya':
			fiducials.append(D_Lyalpha_fid)
			names.append(r'$\mathcal{D}$')
